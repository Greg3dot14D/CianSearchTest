...
INSERT INTO SIEBEL.S_PS_CREDENTIAL (ROW_ID, CREATED, CREATED_BY, LAST_UPD, LAST_UPD_BY, MODIFICATION_NUM, CONFLICT_ID, CATEGORY_CD, CONTACT_ID, CREDENTIAL_NUM, 
                                    ...
                                    X_SBRF_DOC_MIDDLE_NAME, X_SBRF_DOC_NAME, X_SBRF_DOC_STATUS, X_SBRF_DPT_CD, X_SBRF_ISSUE_PLACE, X_SBRF_NUM, X_SBRF_NUM_DIRTY, X_ACT_FLG) 
       (
           SELECT PS_CREDEN_ID, sysdate, '0-1', sysdate, '0-1', 0, '0', 'Passport', PARTY_ID, DUL_MDMID, 
                  ...
                  UPPER(MID_NAME), '21', 'AA', SUBSTR(DUL_MDMID, 3, 3)||'-'||SUBSTR(DUL_MDMID, 6, 3), 'ФМС России', REPLACE(DOC_SERIES, ' ', '')||REPLACE(DOC_NUMBER, ' ', ''), DOC_SERIES||' '||DOC_NUMBER, 'Y'
           FROM AAA_TRSF_CLIENTS_IDS
       );
